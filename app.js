    ...
    row.innerHTML=`
      ...
      <div class="track-info">
        ...
        <div class="track-meta">
          ...
          <strong>DURACIÓN:</strong> ${track.duración}
        </div>
        <div class="context-box">${track.contexto}</div>
        <div class="track-meta"><strong>NOTA:</strong> ${track.nota}</div>
      </div>
    `;
...
document.getElementById('back-10').onclick=()=>audio.currentTime=Math.max(0,audio.currentTime-10);
document.getElementById('forward-10').onclick=()=>audio.currentTime=Math.min(audio.duration,audio.currentTime+10);
...
document.getElementById('close-image').onclick=()=>imgModal.classList.add('hidden');
